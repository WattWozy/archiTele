...
class ArxMcpServerTest {
    ...
    void toolsList_eachToolHasTypeObjectSchema() {
        ...
        assertEquals(6, count, "each of the 6 tools must have inputSchema with type:object");
    }
    ...
    void toolsList_eachToolSchemaHasRequired() {
        ...
        assertEquals(6, count, "each of the 6 tools must have a required array in inputSchema");
    }
